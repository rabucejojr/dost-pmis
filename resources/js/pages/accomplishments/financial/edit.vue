...
const props = defineProps<{ accomplishment: any }>()
...
const form = useForm({ ...props.accomplishment })

const submit = () => form.put(route('financial.update', props.accomplishment.id))
</script>
  ...
  <AppLayout>
    ...
    <section class="max-w-3xl mx-auto py-10 px-6 space-y-8">
      <div class="flex justify-between items-center">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Edit Financial Record</h1>
      ...
      <Card class="dark:bg-gray-900 dark:border-gray-700">
        ...
        <CardContent class="space-y-4">
          <div>
            ...
            <Input v-model="form.project_title" />
          </div>
