...
<template>
  <AppLayout>
    ...
    <section class="max-w-6xl mx-auto py-10 px-4 md:px-8 space-y-8">
      <!-- Header -->
      ...
      <!-- Table -->
      <Card class="border border-gray-200 dark:border-gray-700 shadow-sm dark:bg-gray-900">
        <CardHeader>
          <CardTitle>List of Financial Accomplishments</CardTitle>
        </CardHeader>
        <CardContent>
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                <tr v-for="acc in accomplishments.data" :key="acc.id">
